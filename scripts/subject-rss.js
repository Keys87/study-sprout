...
export function renderButtons() {
    ...
    const resourceApplicator = (resourceName, id) => {
        ...
        const element = `<button type="button" id="${id}" class="w-36 p-2 rounded-2xl shadow-lg transition transform bg-linear-to-r from-[#dde6ef] to-[#cfd9e2] text-black hover:shadow-2xl hover:scale-110 hover:from-[#f5d8cc] hover:to-[#e3c7bc] inline-flex items-center justify-center">${resourceName}</button>`;
        return element;
    }
